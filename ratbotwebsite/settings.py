"""
Django settings for ratbotwebsite project.
...
SECRET_KEY = 'django-insecure-%-9c(thmw8+-eez=l)z9hp3#_njdhj#s$fm)o4gnzfa14xykbg'
...
WSGI_APPLICATION = 'ratbotwebsite.wsgi.application'
